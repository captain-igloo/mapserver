...
CMAKEFLAGS=-DCMAKE_C_FLAGS="--coverage ${CMAKE_C_FLAGS}" -DCMAKE_CXX_FLAGS="--coverage ${CMAKE_CXX_FLAGS}" \
			  ...
			  -DWITH_CLIENT_WFS=1 -DWITH_KML=1 -DWITH_SOS=1 -DWITH_CSHARP=0 -DWITH_PHP=1 -DWITH_PERL=1 \
			  -DWITH_PYTHON=0 -DWITH_JAVA=0 -DWITH_THREAD_SAFETY=1 -DWITH_FRIBIDI=0 -DWITH_FCGI=0 -DWITH_EXEMPI=0 \
			  -DCMAKE_BUILD_TYPE=Release -DWITH_RSVG=0 -DWITH_CURL=0 -DWITH_HARFBUZZ=0 -DWITH_POINT_Z_M=1 -DWITH_CAIRO=0 -DWITH_PROTOBUFC=0 -DWITH_MSSQL2008=ON ${EXTRA_CMAKEFLAGS} -DLIBMAPSERVER_EXTRA_FLAGS="${LIBMAPSERVER_EXTRA_FLAGS}"
all: cmakebuild
